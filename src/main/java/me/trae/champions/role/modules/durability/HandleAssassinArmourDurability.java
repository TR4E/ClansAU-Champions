...
public class HandleAssassinArmourDurability extends SpigotListener<Champions, RoleManager> {

    public HandleAssassinArmourDurability(final RoleManager manager) {
        super(manager);
    }
    ...
    public void onArmourDurability(final ArmourDurabilityEvent event) {
        ...
        if (event.getMaterialType() != ArmourMaterialType.LEATHER) {
            return;
        }
